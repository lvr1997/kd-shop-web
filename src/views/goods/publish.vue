              ...
              <div class="layui-box layui-upload-button">
                ...
                >
                  <input
                    type="file"
                    name="info"
                    class="layui-upload-file info-img-upload"
                  />
                </form>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="publish-form-list">
                      ...
                      <button
                        v-show="!showBuyLink"
                        class="btn buy-link-btn"
                        type="button"
                        @click="handleShowBuyLink"
                      >
                        <PlusSquareOutlined />
                        添加原购买链接
                      </button>
...
const title = "发布闲置";
const nav = ["Home", "Publish"];
const showBuyLink = ref(false) //是否显示购买链接

const handleShowBuyLink = () => {
    showBuyLink.value = !showBuyLink.value;
}
</script>
...
.publish-form-list input[type="text"],
...
.image .layui-box.layui-upload-button {
  width: 153px;
  height: 153px;
  border: #eaedff solid 2px;
}
...
.publish-button button:first-child:hover {
    color: #0b0b0b;
}
